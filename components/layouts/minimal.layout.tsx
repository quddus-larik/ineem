...
export function MinimaDashboard({children}: LUIProps) {
    ...
    return (
      <div className="w-full min-h-screen flex bg-background-secondary dark:bg-background-inverse/2">{/*<FabButton className="bottom-5 right-5 z-10 p-6 rounded-2xl fixed" />*/}
